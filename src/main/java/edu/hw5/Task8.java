...
public class Task8 {
    ...
    private static final String REGEX_ZERO_ODD = "^0((0|1){2})*$";
    private static final String REGEX_ONE_EVEN = "^1((0|1){2})*(0|1)$";
    ...
    public static boolean isStringValidZeroOddOrOneEven(String str) {
        return str.matches(REGEX_ZERO_ODD) || str.matches(REGEX_ONE_EVEN);
    }
